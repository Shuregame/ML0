...
На графике выше хорошо видно, что для нас уже не имеет значение как далеко находятся объекты обучающей выборки, так как вылишь задаем k-ближайших соседей, а точнее k+1, и окно становится нужной нам ширины. На последней графике взяли k=6.
